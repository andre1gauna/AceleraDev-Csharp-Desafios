...
namespace Source.Migrations
{
    ...
    [Migration("20200323165722_FirstMigration")]
            ...
            modelBuilder.Entity("Codenation.Challenge.Models.Acceleration", b =>
                {
                    b.HasOne("Codenation.Challenge.Models.Challenge", "Challenge")
                        ...
                        .HasForeignKey("Codenation.Challenge.Models.Acceleration", "ChallengeId")
            ...
            modelBuilder.Entity("Codenation.Challenge.Models.Candidate", b =>
                {
                    b.HasOne("Codenation.Challenge.Models.Acceleration", "Acceleration")
                        .WithOne("Candidate")
                        .HasForeignKey("Codenation.Challenge.Models.Candidate", "AccelerationId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Codenation.Challenge.Models.Company", "Company")
                        .WithOne("Candidate")
                        .HasForeignKey("Codenation.Challenge.Models.Candidate", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Codenation.Challenge.Models.User", "User")
                        .WithOne("Candidates")
                        .HasForeignKey("Codenation.Challenge.Models.Candidate", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Codenation.Challenge.Models.Submission", b =>
                {
                    b.HasOne("Codenation.Challenge.Models.Challenge", "Challenge")
                        .WithOne("Submission")
                        .HasForeignKey("Codenation.Challenge.Models.Submission", "ChallengeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Codenation.Challenge.Models.User", "User")
                        .WithOne("Submissions")
                        .HasForeignKey("Codenation.Challenge.Models.Submission", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
